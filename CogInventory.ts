        ...
        for (let key of this.availableSlotKeys) {
            ...
            switch (entry.boostRadius) {
                ...
                case "adjacent":
                    ...
                    break;
                case "up":
                    boosted.push([i - 2, j - 1], [i - 2, j], [i - 2, j + 1], [i - 1, j - 1], [i - 1, j], [
                        i - 1, j + 1
                    ]);
                    break;
                case "right":
                    boosted.push([i - 1, j + 2], [i, j + 2], [i + 1, j + 2], [i - 1, j + 1], [i, j + 1], [
                        i + 1, j + 1
                    ]);
                    break;
                case "down":
                ...
                case "corner":
                    ...
                    break;
                case "around":
                    boosted.push([i - 2, j], [i - 1, j - 1], [i - 1, j], [i - 1, j + 1], [i, j - 2], [i, j - 1], [
                        i, j + 1
                    ], [i, j + 2], [i + 1, j - 1], [i + 1, j], [i + 1, j + 1], [i + 2, j]);
                    break;
                case "everything":
                    for (let k = 0; k < INV_ROWS; k++) {
                    ...
                    break;
                default:
                    console.error("missing type", entry.boostRadius);
                    break;
            }
